...
//= require_tree .
  ...
  $(document).on('turbolinks:load', function(){
    ...
    let totalQuantity = $("#num-of-items").text();
    ...
    $(".select-quantity").change(function() {
      ...
      totalSums = totalPrice + price1 + price2 + price3 + price4 + price5 + price6 + price7 + price8 + price9 + price10;
      $("#quantity_price").text("$" + totalSums.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'))
    ...
    /*function total_price(idx, item_price, all_items_price) {
      ...
      onchange: on_change_funct(idx, item['price']
